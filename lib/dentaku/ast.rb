...
require_relative './ast/dictionary'
require_relative './ast/list'
require_relative './ast/case'
require_relative './ast/functions/concat'
require_relative './ast/functions/conversions'
require_relative './ast/functions/date'
require_relative './ast/functions/enumerable'
require_relative './ast/functions/hash'
...
require_relative './ast/functions/string'
